...
import { FaBold, FaMicrophone, FaImage, FaTrash, FaArrowsAltH, FaGripVertical } from 'react-icons/fa';
import { TbMathFunction, TbSubscript, TbOmega, TbArrowsExchange2 } from 'react-icons/tb';
    ...
    return (
        <div className="max-w-4xl mx-auto p-6">
            <div className="flex items-center mb-8 text-gray-600">
                ...
                <div className="ml-auto flex items-center space-x-2">
                    <div className="w-6 h-6 text-blue-600">
                        <TbArrowsExchange2 className="w-full h-full" />
                    </div>
            ...
            <div className="mb-4 flex justify-between items-center">
                ...
                <span className="font-medium">Matching definition</span>
            </div>
